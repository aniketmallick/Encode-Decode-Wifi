...
# print "d is:",d
y = int(ez,2)
# In this loop also same as encryption the loop is used to take out the y that is used in ( y = a ^ b ) 
for i in range(int(d)):
    po=i*d
    po=po%100000
    y=y^po

msg=y^b        # Here we use XOR property i.e. if a ^ b = c then c ^ a = b and also b ^ c  = a . Similarly if y = a ^ b then a = y ^ b here,msg = a
